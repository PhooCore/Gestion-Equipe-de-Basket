...
// Récupération de l'ID du joueur et de ses données
$idJoueur = $_GET['id'] ?? 0;
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        if ($joueurController->modifierJoueur($idJoueur, $donneesJoueur)) {
            ...
            $joueur = $joueurController->getById($idJoueur); // Rechargement des données
        }
    } catch (Exception $e) {
                        ...
                        <form method="POST">
                            ...
                            <div class="marge-bas">
                                ...
                                <input type="text" class="champ-formulaire" id="numero_licence" name="numero_licence" 
                                       value="<?= $joueur['numero_licence'] ?>" required>
                            </div>
