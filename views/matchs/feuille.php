            ...
            <div class="corps-carte">
                <div class="info-match-section">
                    <div class="info-match-item">
                        <h6>Match</h6>
                        <p><strong>Notre Équipe</strong> vs <strong><?= $match['equipe_adverse'] ?></strong></p>
                    </div>
                    <div class="info-match-item">
                        <h6>Date & Heure</h6>
                            ...
                            <?php if ($matchAVenir): ?>
                                <select class="selection-formulaire selection-titulaire" 
                                    ...
                                    <?php foreach ($joueursActifs as $joueur): 
                                        ...
                                        $derniersMatchsJson = json_encode($joueur['derniers_matchs']), ENT_QUOTES, 'UTF-8';
                                    ?>
                                    <option value="<?= $joueur['id_joueur'] ?>" <?= $selectionne ?>
                                            ...
                                            data-commentaire="<?= $commentaireCourt ?>"
                                            data-commentairecomplet="<?= $joueur['commentaire_general'] ?>"
                                            data-prenom="<?= $joueur['prenom'] ?>"
                                            data-nom="<?= $joueur['nom'] ?>"
                                            ...
                                            <div class="info-joueur-details" style="display: block;">
                                                ...
                                                ?>
                                                    ...
                                                    <?php if (strlen($joueurInfo['commentaire_general']) > 100): ?>
                                                        <span class="commentaire-court"><?= $commentaireCourt ?>...</span>
                                                        <span class="voir-plus" onclick="afficherModalCommentaire('<?= $joueurInfo['prenom'] . ' ' . $joueurInfo['nom'] ?>', '<?= addslashes($joueurInfo['commentaire_general']) ?>')">Voir plus</span><br>
                                                    <?php else: ?>
                                                        <?= $joueurInfo['commentaire_general'] ?><br>
                                                    <?php endif; ?>
                                                <?php endif; ?>
                                                ...
                                                <?php if (!empty($joueurInfo['derniers_matchs']) && count($joueurInfo['derniers_matchs']) > 0): ?>
                                                    ...
                                                    <div class="historique-matchs">
                                                        ...
                                                        <div class="match-historique">
                                                            ...
                                                            <span class="match-info"><?= $matchJoueur['equipe_adverse'] ?><?= $posteMatch ?><br><small><?= $titulaire ?></small></span>
                                                        </div>
                                                        <?php endforeach; ?>
