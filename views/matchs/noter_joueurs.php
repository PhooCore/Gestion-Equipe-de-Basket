...
// Vérification que le match a déjà eu lieu
...
// Récupération des participants au match
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        // Validation et traitement de chaque évaluation
        foreach ($_POST['evaluations'] as $joueur_id => $evaluation) {
            $evaluation = trim($evaluation);
            
            // Validation de la présence d'une note
            if ($evaluation === '') {
            ...
            // Validation du format et de l'intervalle de la note
...
<body>
    ...
    <div class="conteneur page">
        ...
        <div class="carte marge-bas">
            ...
            <div class="corps-carte">
                ...
                <?php if ($match['commentaire_match']): ?>
                    <p><strong>Commentaire:</strong> <?= $match['commentaire_match'] ?></p>
                <?php endif; ?>
            </div>
        </div>
        ...
        <!-- Avertissement pour les matchs marqués "À venir" -->
        ...
        <!-- Formulaire d'évaluation des joueurs -->
        <form method="POST">
            <div class="carte">
                <div class="entete-carte">
                ...
                <div class="corps-carte">
                    ...
                    <?php else: ?>
                        <!-- Tableau des participants à évaluer -->
                        <table class="tableau tableau-bande">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?= $participant['numero_licence'] ?></td>
                                    <td>
                                    ...
                                    <td>
                                        <!-- Badge pour titulaire/remplaçant -->
