...
// Récupération de l'ID du commentaire et des données existantes
$idCommentaire = $_GET['id'] ?? 0;
$commentaire = $commentaireController->getById($idCommentaire);

// Redirection si le commentaire n'existe pas
if (!$commentaire) {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        if ($commentaireController->modifierCommentaire($idCommentaire, $donneesCommentaire)) {
            ...
            $commentaire = $commentaireController->getById($idCommentaire); // Rechargement des données
        }
    } catch (Exception $e) {
                    ...
                    <div class="corps-carte">
                        ...
                        <form method="POST">
                            <div class="marge-bas">
                                ...
                                <textarea class="champ-formulaire" id="texte" name="texte" rows="5" required><?= $commentaire['Texte'] ?></textarea>
                            </div>
